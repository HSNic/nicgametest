...
(function () {
  ...
  var COMBAT_SECTIONS = [
    ...
    { t: '⚔ 經典模式（硬核挑戰）', lines: [
      ...
      '<b>例外</b>：<b>職業限定的試煉任務道具不受這個 ×1/10</b>，照原本機率掉；<b>卡瑞的屠龍劍也維持 100% 必掉</b>（擊殺已綁「消耗四樣任務道具」的成本）；其餘一般道具照樣 1/10。',
  ...
  var MAGIC_FACT = {
    // ===== 法師魔法(reqM) =====
    sk_heal1: ['回復量＝(20~40)×(1＋3×魔法傷害÷16)，吃智力、不吃階級；只治療自己'],
    ...
    sk_heal_mid: ['回復量＝(51~100)×(1＋3×魔法傷害÷16)，吃智力、不吃階級；只治療自己'],
    ...
    sk_heal2: ['回復量＝(101~200)×(1＋3×魔法傷害÷16)，吃智力、不吃階級；只治療自己'],
    ...
    sk_regen: ['施放即<b>立即治癒全隊一次</b>(你＋所有傭兵)，不再是每3秒跳一次的持續回復；之後進入 3 秒冷卻才能再放'],
    ...
    sk_full_heal: ['回復量＝(153~300)×(1＋3×魔法傷害÷16)，吃智力、不吃階級；只治療自己'],
    ...
    sk_disintegrate: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×2.00'],
    ...
    sk_elf_lifebless: ['施放即<b>立即治癒全隊一次</b>(你＋所有傭兵)，不再是每3秒跳一次的持續回復；之後進入 6 秒冷卻才能再放'],
    ...
    sk_helm_heal1: ['實際治療量再乘 (1＋3×魔法傷害÷16)，隨智力(魔法傷害)成長'],
    sk_helm_heal2: ['實際治療量再乘 (1＋3×魔法傷害÷16)，隨智力(魔法傷害)成長'],
