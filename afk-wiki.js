...
(function () {
  ...
  var WEAPON_TRAITS = [
    ...
    { n: '武器附魔（傳說武器）', d: '普攻有機率不用學技能就免費施放武器內建的魔法，而且強化值越高越容易觸發（基礎 1%，每強化 +1%）。代表武器：死亡騎士的烈炎之劍、克特之劍、冰之女王魔杖、蕾雅魔杖。<br>武器觸發的法術與親手施放走同一套傷害公式（階級係數、魔法傷害加成、武器強化的「最終傷害倍率」都吃），只是不消耗 MP。' },
  ...
  var COMBAT_SECTIONS = [
    ...
    { t: '怪讓你中「異常狀態」：可抵抗／免疫', blocks: [
      ...
      { t: 'p', p: '特例：<b>暈眩</b>另吃王族被動「王者加護」再 +20% 抵抗；<b>中毒</b>另看潔尼斯戒指／龍騎士覺醒／免毒娃娃。抵抗與免疫多來自<b>飾品、套裝、魔法娃娃</b>；身上<b>同時穿多件都有抵抗率的裝備，數值會直接相加</b>（例：兩件各 +10% 抗暈疊起來是 +20%，不是只算最高的那件）。' }
    ]},
    ...
    { t: '⚔ 經典模式（硬核挑戰）', lines: [
      ...
      '硬核懲罰：<b>物品掉落機率 ×1/10、經驗值減半、怪物金幣減半這三項舊懲罰已分別於過去版本移除，目前一般掉落／經驗／金幣跟一般模式完全相同</b>；<b>唯一例外是「遺物」品質道具：經典模式下固定鎖死 0.0001% 機率</b>，不受怪物原始機率、席琳倍率、幸運暴走兔腳 ×2 影響。（最後更新：2026-07-18）',
      '<b>死亡會損失「該等級最大經驗」的 5%</b>（一般模式死亡不損失經驗）；最多扣到該等級 0%、<b>不會降等</b>。<b>時空裂痕、攻城區死亡不扣經驗</b>，這兩處例外。',
    ...
    { t: '團隊增益怎麼運作:團隊光環 vs 單體輔助共享', blocks: [
      { t: 'p', p: '隊伍（你＋傭兵）裡的增益技能，運作方式分成兩種，不要搞混：' },
      { t: 'tbl', h: ['類型', '運作方式', '目前有哪些'], rows: [
        ['① 團隊光環', '任何一人（本尊或傭兵）施放一次，<b>全隊（你＋傭兵＋寵物＋召喚物）立即都吃到</b>，不用逐一補、同技能不重複疊加', '大地的祝福（防禦(AC) −7）、灼熱武器（額外傷害/命中 +5）、閃亮之盾（防禦(AC) −8）'],
        ['② 單體輔助共享', '施法者<b>自己身上有這個 buff</b>，隊友（你或傭兵）沒有時<b>自動幫忙補滿</b>，每補一人扣一次施法者的 MP（不是免費群發，MP不夠就停）', '神聖武器、敏捷提升、加速術、祝福武器、力量提升、絕對屏障、幻術士的歐吉/焦點/巫妖/鑽石高崙/化身、精靈的水之元氣、風之射擊、大地護盾、精準射擊、暴風之眼、治癒能量風暴等'],
        ['③ 純自己用、不分享', '只有施法者自己生效，不會給隊友', '鋼鐵防護（僅自身防禦(AC) −10；曾經是全隊減傷，已改版收回）']
      ]},
      { t: 'p', p: '判斷方式：<b>大地的祝福／灼熱武器／閃亮之盾</b>是①團隊光環（一人放全隊爽）；<b>其餘大部分「自動維持」類增益</b>是②單體輔助共享（施法者要自己先有，才會分給缺的隊友，且吃 MP）；<b>鋼鐵防護</b>目前是③只顧自己。' }
    ]},
  ...
  var TRIAL_50 = {
    knight: { n: '騎士 50 級試煉', npc: '迪嘉勒廷 ＠象牙塔（需等級 50）', req: '兩階段依序交付：①丹特斯的召書 ×1 → ②精靈的私語 ×10', from: '丹特斯的召書：黑暗妖精將軍 1%（燃柳村·大洞穴隱遁者村莊／拉斯塔巴德正門／拉斯塔巴德·魔獸訓練場）；精靈的私語：在「燃柳村·精靈墓穴」打任何怪 1% 掉', rw: '完成後開放「魔族神殿」。在魔族神殿打「炎魔的惡魔」（Lv61，每次掉 3 個）取得「炎魔之劍」，每 1 個回來找迪嘉勒廷換 1 把傳說武器「黑焰之劍」（可重複換）' },
    ...
    illusion: { n: '幻術士 50 級試煉', npc: '希蓮恩 ＠希培利亞村莊（需等級 50）', req: '第一階段：交付 時空裂痕碎片 ×100', from: '時空裂痕碎片：底比斯系列怪掉落（時空裂痕領域；多為 10%，固定數量）', rw: '完成後開放「魔族神殿」。之後可重複：每交付 翼龍之血 ×5（遺忘之島飛龍 5%，在遺忘之島本島）換 1 把傳說武器「藍寶石奇古獸」（可重複換）' },
    dragon: { n: '龍騎士 50 級試煉', npc: '普洛凱爾 ＠貝希摩斯（需等級 50）', req: '第一階段：交付 時空裂痕碎片 ×100', from: '時空裂痕碎片：底比斯系列怪掉落（時空裂痕領域；多為 10%，固定數量）', rw: '完成後開放「魔族神殿」。之後可重複：每交付 靈魂之火灰燼 ×1（火焰之靈魂 1%，傲慢之塔 41~50 樓）換 1 把傳說「消滅者鎖鏈劍」（可重複換）' }
  };
  ...
  var ENHANCE_SECTIONS = [
    ...
    { t: '詞綴怎麼來', lines: [
      ...
      '<b>第5階(最高階)屬性武器可額外附加一個觸發技能</b>：用對應元素的『屬性強化卷軸』(火/水/風/地，怪物掉落)在碧恩身上施法，<b>1%</b>機率成功附加一個該元素的攻擊觸發魔法(失敗只消耗卷軸、武器不受影響)；<b>原生已內建攻擊/命中觸發技能的武器(含遺物)無法使用這個功能</b>。已附加過的也可以用同元素卷軸再次施法嘗試重抽換掉現有效果，機率一樣是1%。' + '<span style="color:#64748b;font-size:11px;">(2026-07-21)</span>',
      '附加魔法有<b>星級</b>(最高3星)：重抽抽到<b>同一招</b>技能會<b>升1星</b>(觸發率跟著乘上星數，如原本5%的招升到2星變10%、3星變15%)；抽到<b>不同招</b>則整個換成新技能、<b>降回1星</b>。失敗時原效果與星級都不變。' + '<span style="color:#64748b;font-size:11px;">(2026-07-21)</span>'
    ]}
  ];
  ...
  var TOWER_SECTIONS = [
    ...
    { t: '支配符的額外用途：不進塔也能設定「魔物追蹤」（2026-07-20 新增）', lines: [
      '如果背包裡帶著某段樓層（11~20樓、21~30樓…91~100樓）的<b>支配符</b>，即使你人不在塔裡，也可以在血盟城堡的「魔物追蹤」功能裡直接指定該段樓層裡的怪物當追蹤目標——<b>只有支配符有這個效果，傳送符跟移動卷軸都不算</b>。',
      '這個資格只看你身上「現在」有沒有帶著支配符：把它賣掉或存進倉庫，該段樓層就會從可追蹤清單裡消失（已經生效中的追蹤不會被中斷）。魔物追蹤本身的規則見「血盟」分頁。'
    ]}
  ];
  ...
  var DARKELF_SANCT_SECTIONS = [
    ...
    { t: '掉落與真．冥皇套裝', blocks: [
      { t: 'p', p: '吉爾塔斯必掉 ' + wI('吉爾塔斯的封印') + '，另有機率掉遠古弓/爪/雙刀、多款飾品與防具、大量技能書，以及極稀有的 ' + wE('吉爾塔斯之劍') + '／' + wE('吉爾塔斯魔杖') + '（約 0.1%）。這兩把武器的「擊殺後額外傷害/額外魔法點數」是依你的<b>邪惡性向值</b>縮放的（見「性向與PVP」分頁）：越邪惡加成越高，滿邪惡時劍額外傷害 +10、魔杖額外魔法點數 +20（皆持續10秒）；性向值中立或正義（≥0）則完全沒有這個加成。' },
  ...
  // ===== 安塔瑞斯副本(本檔維護;v3.7.57 新增) ================================
  var ANTHARAS_SECTIONS = [
    { t: '怎麼進去：找威頓村的多魯嘉貝爾', lines: [
      '入口是「' + wL('威頓村') + '」（火山村）的 NPC「' + wN('多魯嘉貝爾') + '」，這 4 張地圖都<b>不能從地圖選單直接選</b>，只能透過他傳送進去。',
      '<b>每日限次、全帳號共用</b>：相同遊戲模式(一般/經典)底下的<b>所有存檔角色，合計每天只能通關 1 次</b>（UTC+8 凌晨 0 點重置），不是每個角色各一次。<b>只有真的打贏通關才會消耗這 1 次</b>——中途失敗或主動離開完全不算數，隨時可以重來。',
      '進場前身上不能處於<b>石化／麻痺／冰凍／暈眩／睡眠</b>狀態，否則會被擋下。'
    ]},
    { t: '副本規則：不能傳送、離開視同失敗', lines: [
      '副本內<b>禁止使用傳送術與瞬間移動卷軸</b>（卷軸不會被消耗，只是用不出去）。',
      '副本內<b>死亡＝挑戰失敗</b>（不會扣今日次數，回村後可再挑戰）；中途主動「回村」也視同放棄，同樣不計入次數、不算通關。',
      '<b>只有真正擊敗最終頭目才算通關</b>，通關後會自動傳送回威頓村。'
    ]},
    { t: '四個區域，逐關深入', blocks: [
      { t: 'tbl', h: ['區域', '頭目'], rows: [
        ['入口', wB('喀瑪南') + ' / ' + wB('喀瑪焰')],
        ['通道', wB('喀瑪南王') + ' / ' + wB('喀瑪焰王')],
        ['深處', wB('喀瑪王') + '（中央）＋' + wB('大地荒龍') + '（其餘）'],
        ['棲息地（最終區）', wB('被侵蝕的安塔瑞斯') + '（三段變身，中央）＋' + wB('大地荒龍') + '（其餘，固定 5 秒重生）']
      ]},
      { t: 'p', p: '每一區<b>擊敗該區頭目就自動深入下一區</b>，不用自己選地圖；棲息地是最終區，擊敗最終形態才算通關。' }
    ]},
    { t: '最終頭目：三段變身，一路變強', lines: [
      '棲息地的' + wB('被侵蝕的安塔瑞斯') + '會經歷<b>三個階段</b>（大地→血怒→瘋狂），只有<b>最終「瘋狂」形態</b>被擊敗才算通關並結算掉落——<b>前兩階段不死不掉落</b>，中途被打死不繼續往下一階段。',
      '一般攻擊約是<b>同等級一般怪的 2 倍傷害</b>，屬於重砲台型頭目，建議衝高防禦/減傷再挑戰。'
    ]},
    { t: '助戰者系統：指定 4 名「未受僱」角色提供被動加成', blocks: [
      { t: 'p', p: '在多魯嘉貝爾的對話視窗可以指定<b>最多 4 位（護衛／抵抗／精準／破壞 各 1 位）</b>「助戰者」——助戰者<b>不會實際上場戰鬥</b>，只是借用該角色的能力數值，讓主玩家獲得被動加成。<b>已經是別人傭兵的角色不能兼任助戰者</b>，反之亦然。' },
      { t: 'tbl', h: ['職務', '效果'], rows: [
        ['護衛', '主玩家額外獲得該角色 10% 魔防(MR)的傷害減免(最高 20%)'],
        ['抵抗', '主玩家額外獲得該角色 100% 的地屬性抗性(最高 +30)'],
        ['精準', '主玩家額外獲得該角色 5% 等級的額外命中(最高 +20)'],
        ['破壞', '主玩家額外獲得該角色 5% 的近距離傷害、遠距離傷害、魔法傷害、額外魔法點數(每項最高 +20)']
      ]},
      { t: 'p', p: '助戰者是<b>指定當下的能力快照</b>，換裝/升級不會自動更新，要重新指定一次才會刷新。' }
    ]},
    { t: '地龍之魔眼：被石化時的隱藏機制', lines: [
      '身上帶著<b>已解封的地龍之魔眼</b>時，被石化的瞬間會觸發：<b>立即解除石化</b>、接下來 <b>10 分鐘內免疫石化</b>，並獲得額外傷害／額外命中／ER 各 +5（每小時最多觸發 1 次）。',
      wI('受封印 地龍之魔眼') + '要帶去威頓村找「米米」支付代價解封才能使用；魔眼是獨立欄位(第二頁空白處，限 1 個)，不佔一般飾品格。'
    ]},
    { t: '材料兌換與裝備', lines: [
      '擊敗最終頭目掉落的「安塔瑞斯之X」系列材料(鱗/骨/爪/血/肉/牙/眼)，可拿去威頓村找「萊利的輔佐官」兌換積分，換取安塔瑞斯素材禮包與抽獎機會。',
      '專屬裝備：4 件「古代龍鱗盔甲」(地/水/火/風)、「安塔瑞斯」系列 4 件飾品(力量/魅惑/泉源/霸氣)、遠程武器「深紅之弩」——這些在<b>掉落查詢直接搜物品名就查得到</b>，出沒地圖會列到這 4 張副本地圖。',
      '幼龍蛋（頑皮／淘氣，孵化寵物用）也會從這 4 隻龍身上掉，詳見「掉落查詢」搜尋「幼龍蛋」。'
    ]}
  ];

  function renderAntharas() {
    var note = '<div class="m-wiki-note">「侵蝕的安塔瑞斯巢穴」是 4 張獨立地圖，<b>無法從地圖選單選擇</b>，只能靠威頓村 NPC「多魯嘉貝爾」傳送進去；相同模式全帳號<b>每天合計只能通關 1 次</b>。下面說明進入方式、四段推進、頭目機制與掉落。</div>';
    ...
    return note + secs + '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:' + TAB_UPDATED.antharas + '(新增分頁,說明v3.7.57安塔瑞斯副本進入方式/四段推進/助戰者/地龍之魔眼/材料兌換)</div>';
  }
  ...
  var STAT_CAP_SECTIONS = [
    ...
    { t: '✦ 萬能藥稀有掉落', lines: [
      '打<b>等級 40 以上、且非血盟</b>的怪有機率掉萬能藥，擊殺後隨機給 6 種其中一種，<b>力量／敏捷／體質／智力／精神／魅力六種機率完全相同</b>（含魅力，不再是有的種類特別少見）。',
      '機率：<b>頭目 1%</b>、<b>一般怪 0.01%</b>（萬分之一）。',
      '例外：<b>夢幻之島的頭目不掉</b>。',
      '（另外，四大元素精靈王等部分頭目本來就會固定掉特定屬性的萬能藥，那是各自的掉落表，與上面這個通用稀有掉落分開計算。）',
      '潘朵拉黑市的「收購單」現在也<b>開放收購萬能藥</b>（見「潘朵拉黑市」分頁），是收購單機制裡唯一允許登記的消耗品——其餘量產消耗品都不能用收購單指定收購。',
      '最後更新:2026-07-18(補充六種萬能藥掉落機率相同、潘朵拉黑市開放收購萬能藥)'
    ]}
  ];
  ...
  var TAB_CATS = [
    ...
    { k: 'zone', n: '地圖與特殊地城', tabs: ['map', 'eleTraining', 'sherine', 'tower', 'oblivion', 'rift', 'kingroom', 'darkelf_sanct', 'antharas'] },
  ...
  var TAB_UPDATED = {
    ...
    pandora: '2026-07-21',
    pvp: '2026-07-21',
    darkelf_sanct: '2026-07-18',
    pledge: '2026-07-21',
    worldchat: '2026-07-21',
    antharas: '2026-07-24'
  };
  ...
  function tabHTML(key, cls) {
    ...
    if (key === 'worldchat') return renderWorldChat();
    return '';
  }
  ...
  var SEARCH_SOURCES = [
    ...
    { key: 'pvp', cls: false, label: '性向與PVP' },
  ...
  var MASTERY_FACT = {
    ...
    e_spirit: ['基準 1 隻 → 1＋魅力/10、上限 7 隻（屬性精靈與強力屬性精靈皆適用）'],
    ...
    i_illusion: ['歐吉：每 2 秒近戰一次，傷害 3~60＋智力/5×(1＋等級/10)', '巫妖：每 3 秒魔法一次（必中、吃魔抗），傷害 3~60＋智力/5×(1＋等級/10)', '鑽石高崙：每 1 秒近戰一次，傷害 2~40＋智力/5×(1＋等級/5)，命中後 10% 追加冰矛圍籬', '沒有持續時間限制：幻覺 buff 在就一直打'],
    ...
    k_royal_pet: ['出戰寵物：傷害 ×1.5、命中 ×1.5、受到傷害 −50%（持續傷害/DoT 是固定真傷，不受此減免）', '不再有 HP 上限加成（舊版 ×2 已取消）；魅力係數固定 0.10，不因這個精通而變動'],
  ...
  function renderPets() {
    // 📅 最後更新:2026-07-17(隨同步v3.4.86核對,取代v3.2.17前的舊項圈系統敘述——舊系統已被作者移除,別再照舊版寫)
    var note = '<div class="m-wiki-note">「帶寵物」是<b>任何職業</b>都能玩的夥伴系統(v3.2.17全面改版，取代舊版吃肉/項圈/哨子玩法)：用專屬誘捕道具捕捉野外動物送進' + wN('包武') + '的' + wI('寵物保管') + '，寵物是有等級/經驗/HP/MP的<b>獨立實體</b>，最多同時<b>出戰4隻</b>幫你打怪。</div>' +
      '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:2026-07-21(補四大蜥蜴獲得管道與黃金龍基準輸出說明)</div>';
    var lureRows = [
      ['漂浮之眼肉', '狼／牧羊犬／杜賓狗／哈士奇／熊／貓／浣熊／聖伯納犬／狐狸／小獵犬／柯利(高麗幼犬不吃此道具)', wB('漂浮之眼') + ' 10%掉落'],
      ['胡蘿蔔', '暴走兔', wB('暴走兔') + ' 本體10%掉落'],
      ['虎男誘食', '老虎→虎男', wB('馴獸師') + '／' + wB('喚獸師') + ' 10%掉落'],
      ['袋鼠的飼料', '袋鼠', wB('袋鼠') + ' 本體10%掉落'],
      ['熊貓的飼料', '熊貓', wB('熊貓') + ' 本體10%掉落'],
      ['猴子的飼料', '猴子', wB('猴子') + ' 本體10%掉落'],
      ['高麗犬誘食', '高麗幼犬(專屬誘捕，一般誘捕道具不吃)', wB('高麗幼犬') + ' 本體10%掉落']
    ];
    var secs = [
      { t: '① 怎麼抓(誘捕道具)', body:
        wDesc('使用對應誘捕道具 → 掛「誘捕」狀態<b>600秒</b>，期間打死指定的野外動物即<b>直接送進寵物保管</b>(不是機率、是必定成功)，同時消耗掉誘捕狀態。全部誘捕道具都是<b>怪物擊殺10%掉落</b>，不是商店販售。') +
        wTbl(['誘捕道具', '誘捕對象', '從哪掉'], lureRows) +
        wDesc('遺物「' + wE('馴獸師的飼料袋') + '」裝備時視為<b>全部誘捕同時生效且不消耗</b>，卸下即失效。')
      },
      { t: '② 出戰上限與魅力門檻', body:
        wDesc('同時<b>最多出戰4隻</b>，每隻寵物依種類需要不同' + wST('魅力') + '：') +
        wTbl(['所需魅力', '寵物種類'], [
          ['6', '基礎系(牧羊犬、貓、熊、杜賓狗、狼、浣熊、小獵犬、聖伯納犬、狐狸、暴走兔、哈士奇、柯利等)'],
          ['12', '中階特殊系(虎男、高麗幼犬、袋鼠、熊貓、猴子)'],
          ['15', '龍系一般型態(頑皮龍、淘氣龍)'],
          ['20', '黃金龍(最終型態)']
        ]) +
        wDesc('出戰所需魅力依序累加，超過目前魅力值或超過4隻即無法出戰；換角色/魅力下降時系統會自動把超額的寵物收回保管，並在訊息說明原因。')
      },
      { t: '③ 經驗與升級', body:
        wDesc('你戰鬥實得的經驗會<b>複製一份</b>，均分給所有出戰中、尚未倒地的寵物；若某隻寵物等級已達到你的等級上限則不再累積經驗，改由其餘寵物均分。') +
        wDesc('升級所需經驗 ＝ 玩家對應等級升級需求的 <b>1/10</b>。升級時HP/MP按各寵物固定區間隨機成長。')
      },
      { t: '④ 死亡與復活', body:
        wDesc('倒地後<b>等待5秒</b>，若背包有「' + wI('復活卷軸') + '」會自動消耗復活；持有遺物「巨靈的承諾耳環」可<b>跳過5秒冷卻立即復活</b>(仍消耗卷軸)。沒帶復活卷軸則持續等待，直到你補貨或撿到。') +
        wDesc('' + wS('返生術') + '可讓寵物<b>立即復活</b>，不受5秒冷卻限制。若你目前<b>不在野外(安全區/城鎮)</b>，寵物會<b>立即免費復活</b>，不消耗卷軸。') +
        wDesc('回到安全區/城鎮時(比照傭兵)，出戰中的寵物<b>不只倒地的免費復活，全部出戰寵物都會補滿HP/MP、並清除異常狀態</b>，等於回村就是一次全體重整。' + '<span style="color:#64748b;font-size:11px;">(2026-07-20)</span>') +
        wDesc('遺物「珍愛夥伴的執念」(項鍊)：佩戴時寵物復活後<b>8秒內</b>受到的傷害<b>減少100%</b>(物理/魔法都免疫)、一般攻擊額外傷害<b>+8</b>，等於給剛復活的寵物一段無敵保護期。' + '<span style="color:#64748b;font-size:11px;">(2026-07-21)</span>')
      },
      { t: '⑤ 進化(找包武·等級30以上)', body:
        wDesc('玩家<b>等級30以上</b>、且該寵物是<b>一般型態(基礎階)</b>時才能進化，兩條路徑：') +
        wTbl(['材料', '結果'], [
          ['進化果實', '進化為對應的「高等○○」(依種類固定)'],
          ['勝利果實', '統一進化為「黃金龍」(哪隻基礎寵物都可以)']
        ]) +
        wDesc('若同時持有兩種果實，會跳出選擇讓你自選方向。<b>高等型態與黃金龍皆為最終型態，不可再進化</b>。進化後：<b>等級重置為1、經驗歸零、HP/MP上限變成進化前的50%</b>。') +
        wDesc('材料怎麼來(皆在' + wL('亞丁') + '找「諾斯」製作)：' + wI('進化果實') + '＝光明的鱗片×100＋綠寶石×20＋金幣20000；' + wI('勝利果實') + '＝' + wI('龍之心') + '×1＋高品質紅寶石×5；' + wI('龍之心') + '本身是' + wB('幼龍') + ' 0.01%掉落。')
      },
      { t: '⑥ 寵物保管(找亞丁的包武)', body:
        wDesc(wN('包武') + '(位於' + wL('亞丁') + '城右下拱廊前)幫你保管寵物，最多<b>32隻</b>(含出戰中的)，<b>同模式(一般/經典)全部角色共通</b>——和單一角色專屬的舊系統不同，帳號底下任何角色都能看到同一批寵物。' + '<span style="color:#64748b;font-size:11px;">(2026-07-21，上限20→32)</span>') +
        wDesc('出戰、鎖定、放生、進化都在這個介面操作。「目前正在出戰中」只認領出的那個角色，換角色不會自動搶走別人正在用的寵物；要領出別人正在使用的寵物，須先由原角色收回。')
      },
      { t: '⑦ 王族專屬「夥伴精通」', body:
        wDesc('王族學了' + wS('夥伴精通') + '(k_royal_pet)專精後：出戰寵物<b>傷害×1.5、命中×1.5、受到傷害−50%</b>(持續傷害/DoT不算，DoT是固定真傷、不受任何減免)。非王族或沒學這個精通則沒有這些加成。') +
        wDesc('傭兵召喚物也會被團隊治療/回血效果(如' + wS('體力回復術') + '等HoT)加成回血。')
      },
      { t: '⑧ 袋鼠系專屬穿甲', body:
        wDesc('<b>袋鼠 / 高等袋鼠</b>攻擊自帶 <b>35% 護甲穿透</b>：對目標造成傷害時會忽略對方 35% 的「傷害減免(dr)」數值，其餘寵物沒有這個特性。' + '<span style="color:#64748b;font-size:11px;">(2026-07-20)</span>')
      },
      { t: '⑨ 四大蜥蜴：吃蛋直接獲得，一出生就是最終型態', body:
        wDesc('這四隻不是誘捕來的，是打怪掉「遺物」等級的<b>蛋</b>、使用後<b>直接送進寵物保管</b>(寵物保管滿了無法使用，蛋不會消失)：') +
        wTbl(['蛋(遺物)', '孵出', '哪裡掉(機率)'], [
          ['充滿厄運氣息的蛋', '厄運蜥蜴', '飛龍 0.01%(龍之谷)'],
          ['充滿災厄氣息的蛋', '災厄蜥蜴', '深淵地靈 0.01%(底比斯地監)'],
          ['充滿破滅氣息的蛋', '破滅蜥蜴', '遺忘之島飛龍 0.01%(遺忘之島)'],
          ['充滿詛咒氣息的蛋', '詛咒蜥蜴', '骨龍 0.01%(古魯丁地監)']
        ]) +
        wDesc('四隻都是<b>基礎階、無法再進化</b>(一出生就是最終型態)，所需魅力15(跟龍系一般型態同級)，但輸出強度直接看齊<b>黃金龍</b>：普攻/技能傷害會拿「自己原本的數值」跟「換算成黃金龍基準算出來的數值」比較、<b>取較高者</b>，等於基礎階寵物打出黃金龍等級的傷害，各自還有專精方向：') +
        wTbl(['蜥蜴', '普攻強度(比黃金龍)', '技能強度(比黃金龍)', '額外特性'], [
          ['厄運蜥蜴', '×1.60', '×1.60', '—(普攻/技能均衡強化)'],
          ['災厄蜥蜴', '×2.05', '×2.05', '防禦更硬(AC額外−5)、魔防+20，且是<b>坦型</b>(被攻擊機率是一般寵物5倍，容易吸怪)'],
          ['破滅蜥蜴', '×2.10', '×1.05', '普攻極強，且攻擊自帶<b>35%護甲穿透</b>(無視目標35%傷害減免)'],
          ['詛咒蜥蜴', '×1.35', '×2.60', '技能極強(冰雪暴還帶凍結機率)，走法系輸出']
        ])
      }
    ];
    var cards = secs.map(function (s) {
      return '<div class="m-wiki-card"><div class="m-wiki-name">' + esc(s.t) + '</div>' + s.body + '</div>';
    }).join('');
    var petTable = '';
    if (typeof PET_BOOK !== 'undefined' && PET_BOOK) {   // 讀遊戲的寵物圖鑑,作者新增寵物種類會自動出現
      var td = 'style="padding:3px 6px;border-bottom:1px solid #1e293b;color:#e2e8f0;"';
      var rowOf = function (nm) {
        var p = PET_BOOK[nm];
        var skillNames = (p.sk || []).map(function (s) { return s.n; }).join('、') || '—';
        return '<tr>' +
          '<td ' + td + '><b>' + esc(nm) + '</b></td>' +
          '<td ' + td + '>' + esc((PET_KIND_LABEL && PET_KIND_LABEL[p.kind]) || p.kind) + '</td>' +
          '<td ' + td + '>' + (p.tier === 0 ? '基礎' : (p.tier === 1 ? '高等' : '黃金龍')) + '</td>' +
          '<td ' + td + '>' + (p.cha || 6) + '</td>' +
          '<td ' + td + '>' + (p.evo ? '可進化為 ' + esc(p.evo) : '—') + '</td>' +
          '<td ' + td + '>' + esc(skillNames) + '</td>' +
          '</tr>';
      };
      var names = Object.keys(PET_BOOK);
      var tierOrder = { 0: 0, 1: 1, 2: 2 };
      names.sort(function (a, b) { return (tierOrder[PET_BOOK[a].tier] || 0) - (tierOrder[PET_BOOK[b].tier] || 0); });
      petTable = '<div class="m-wiki-card"><div class="m-wiki-name">寵物圖鑑一覽</div>' +
        '<div class="m-wiki-desc" style="color:#94a3b8;margin:2px 0 6px;">類型影響受擊權重(物理型4／特殊型3／魔法型2，怪物一般攻擊選目標時的權重)。所需魅力是「出戰」門檻，見上方②。</div>' +
        '<table style="width:100%;border-collapse:collapse;font-size:12.5px;"><tbody>' +
        '<tr><th ' + td + '>名稱</th><th ' + td + '>類型</th><th ' + td + '>階級</th><th ' + td + '>所需魅力</th><th ' + td + '>進化</th><th ' + td + '>技能</th></tr>' +
        names.map(rowOf).join('') + '</tbody></table></div>';
    }
    return note + petTable + cards;
  }
  ...
  function renderCraft() {
    ...
    for (var npcId in CRAFT_RECIPES) {
      ...
      if (npcId === 'npc_kororanz') html += '<div class="m-wiki-desc" style="margin-top:4px;">・🏛️ <b>聖地遺物</b>（上面拉斯塔巴德五件傳說武器各需 ×100）取得：持有「<b>死亡騎士之印記</b>」時，在<b>拉斯塔巴德區域</b>擊敗<b>任何</b>怪有 <b>0.1%</b> 機率掉落（一般／經典同機率，經典模式的掉落倍率懲罰已於過去版本移除）；它不在任何怪的固定掉落表內，掉落查詢要直接搜「聖地遺物」。「死亡騎士之印記」由拉斯塔巴德地監的「長老．X」系列怪掉（各約 3%，唯一、不佔倉、可賣）。</div>';   // 聖地遺物是條件式掉落,在此(它的用途旁)解釋取得
    }
  ...
  function renderPandora() {
    ...
    out += wCard('📌 收購單（自己指定要買的東西）',
      ...
      wDesc('消耗品原則上不能登記收購單，<b>唯一的例外是六種萬能藥</b>（新開放）——萬能藥可以正常登記收購單，其餘藥水/卷軸等消耗品仍不行。')
    );

    out += wCard('💎 龍之鑽石怎麼賺（玩家收購 NPC）',
      wDesc('在安全區（<b>席琳神殿、肯特／海音／風木三座攻城據點、炎魔謁見所除外</b>——拉斯塔巴德、傲慢之塔、時空裂痕、沉默洞穴系現在都會出現）會隨機出現「玩家收購 NPC」（其實是本機亂數生成的假玩家，不是真人），交出他指定的裝備／道具即可換取<b>龍之鑽石</b>（數量依委託而定）。指定物品可以從<b>道具欄或倉庫</b>任一處扣除，已穿戴的裝備不會被消耗。') +
      wDesc('這位 NPC 每 <b>10 分鐘</b>才會判定一次要不要出現，且每次判定約 <b>10%</b> 機率成功，換算下來平均要等上數十分鐘到一兩小時才會遇到一次，看不到是正常情況，耐心等待即可。') +
      wDesc('這個 NPC 出現後每 3 分鐘會在頻道喊一次收購廣播，持續最多 <b>3 小時</b>後自動離開。點擊他可以選：<b>「吵死了」</b>——讓他當場閉嘴、不再廣播（人還留在原地，一樣要等滿 3 小時才會消失）；或<b>「馬上到」</b>——直接傳送過去他所在的安全區（會自動幫你結束攀塔排名賽／時空裂痕／遺忘之島等特殊旅程狀態，並自動讓他閉嘴）。跟他對話互動過，也會自動停止他的廣播。（最後更新:2026-07-19,v3.5.76）')
    );
    ...
    out += wCard('😤 別把玩家收購NPC惹毛了——他會記仇、還會變成怪物來找你',
      wDesc('嫌他廣播太吵、點「吵死了」要他閉嘴時，他有 <b>80%</b> 機率不甘心地嗆辣回嘴（另外 20% 才是乖乖道歉）。嗆辣回嘴當下，再有 <b>20%</b> 機率把你記進「黑名單」，記仇效期 <b>2 小時</b>。') +
      wDesc('身上有未過期記仇記錄時，之後在<b>野外（非BOSS房、非攻城區）</b>怪物重生，每次都有 <b>5%</b> 機率把記仇的那位NPC生成成一隻敵對怪物來堵你——牠等級＝你的等級 <b>+5</b>（上限 100），會持續回血、不掉經驗與金幣、外觀就是那個NPC本人的職業動畫，同一位NPC同時只會出現一隻。') +
      wDesc('你只要死掉一次，或反過來把這隻找碴的NPC打死，記仇記錄就會解除。<b>擊敗</b>他：系統會宣告「悻悻然地下線了」、有 <b>10%</b> 機率掉一件裝備（比一般血盟的 1% 掉裝率高），經驗與金幣同樣是 0。') +
      wDesc('這整套跟下面「性向與PVP」分頁的性向值系統是兩回事、互不影響——這裡的NPC找碴完全跟你的正義／邪惡值無關，純粹是「惹毛了就可能被堵」。') +
      wDesc('點「嘲諷」選一句話嗆對方，後續也可能觸發記仇（機率依<b>對方</b>的性向值：越邪惡越容易記仇，邪惡100%、中立50%、正義只有20%），沒有記仇的話還有20%機率對方直接<b>封鎖你</b>（之後再點他只會顯示「已被封鎖」，不能再互動，直到他自然離場）。' + '<span style="color:#64748b;font-size:11px;">(2026-07-20)</span>')
    );
    ...
    out += wCard('🏴 玩家收購NPC也可能是NPC血盟成員' + '<span style="color:#64748b;font-size:11px;">(2026-07-21)</span>',
      wDesc('玩家收購NPC出現時有 <b>50%</b> 機率隨機加入「血盟」分頁提到的20個NPC血盟其中之一(無盟則單純是散人)，跟世界頻道NPC、野外遇到的敵對玩家NPC是同一套身分規則——同名字代表同一個「人」。這只是身分標示，不影響收購/兌換本身的玩法。')
    );

    out += '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:' + TAB_UPDATED.pandora + '(v3.5.36新增遺物布告欄與玩家收購NPC/收購單機制;v3.5.59新增白目玩家記仇/敵對怪機制;補嘲諷選單記仇機率依對方性向值/封鎖機制說明;2026-07-21補收購NPC接入NPC血盟世界)</div>';
    return out;
  }

  // 😤 v3.5.59 白目玩家 / 💙 v3.5.75~76 性向值(PVP)系統(js/03-combat-core.js 核心邏輯、js/04/05 擊殺與死亡結算、js/07 施法門檻、js/10 UI):
  //   純粹讀 player.alignmentValue/pvpOn/pvpRevengeList 顯示規則,不寫入存檔;數值與門檻都對照 code 常數(PVP_ALIGN_*/PVP_REVENGE_*/PVP_WILD_CHANCE)。
  function renderPvp() {
    var out = '<div class="m-wiki-note">「性向與PVP」是全新的正義／邪惡系統：野外會隨機遇到假玩家NPC，打死他們會讓你的「性向值」變動，性向值本身又會影響治癒魔法效果、部分武器加成、甚至有的法術完全不能放。首頁狀態列或「PVP」分頁可以開關要不要遇到這些假玩家、查看性向值與復仇名單。</div>';

    out += wCard('🎭 這些「假玩家」是什麼',
      wDesc('開啟「是否開啟 PVP」開關後，在<b>野外（非BOSS房、非攻城區）</b>，怪物重生時每次有 <b>1%</b> 機率額外冒出一個假玩家NPC（本機隨機生成，不是真人），頂著隨機的中二風格名字、隨機職業外觀，胸口名字顏色會依他的性向值變化（越正義越偏藍白、越邪惡越偏紅白）。不開這個開關就完全不會遇到。')
    );

    out += wCard('⚖️ 性向值：打死正義/邪惡假玩家的影響（v3.6.35 更新）',
      wTbl(['行為', '性向值變化'], [
        ['擊殺一般小怪（非血盟、非攻城）', '<span style="color:#86efac">+1</span>'],
        ['擊殺「正義」假玩家（性向值 ≥ 1000）', '<span style="color:#f87171">−6000</span>'],
        ['擊殺「中立」假玩家', '<span style="color:#f87171">−3000</span>'],
        ['擊殺「邪惡」假玩家（性向值 ≤ −1000）', '不扣分']
      ]) +
      wDesc('懲罰值比舊版加倍（原 −3000/−500 → 現 −6000/−3000），想維持正義稱號要更小心。<b>在攻城區域內擊殺不扣分</b>，其餘規則不變。') +
      wDesc('性向值範圍 <b>−32767 ~ +32767</b>：<b>≥1000</b> 算「正義」、<b>≤−1000</b> 算「邪惡」，中間算「中立」。')
    );

    out += wCard('🎁 打死假玩家掉裝備、還有機率掉遺物（2026-07-20 補充）',
      wDesc('打死假玩家/白目玩家NPC有機率額外掉一件裝備（強化/詞綴走跟血盟野外一樣的規則，可能帶「祝福的」），機率依對方的性向值決定，越邪惡機率越高：') +
      wTbl(['對方性向值', '掉裝備機率'], [
        ['−30000 以下', '10%'],
        ['−20000 ~ −29999', '9%'],
        ['−10000 ~ −19999', '8%'],
      ...
      wDesc('另外還有<b>額外獨立判定的 0.001% 機率</b>掉「遺物」等級道具（全部遺物池均等抽取，裝備幸運暴走兔腳可以讓這個機率變 2 倍），跟上面的裝備掉落互不排擠、可以同時觸發。攻城區域內擊殺假玩家不會掉落任何裝備或遺物。')
    );

    out += wCard('😤 白目玩家「第二能力模板」（30% 機率抽到，更強）',
      wDesc('每次生成假玩家NPC時，遊戲會用<b>70%機率抽原本的模板、30%機率抽「強化版第二模板」</b>——第二模板的血量、防禦、魔防、攻速全面提升，而且會帶新技能，比一般假玩家更難纏。') +
      wTbl(['職業', '第二模板新技能'], [
        ['騎士', '反擊屏障：一段時間內受到攻擊會反傷；堅固防護的傷害減免也變強'],
        ['妖精', '汙濁之水（見下方單獨說明）；生命的祝福：恢復場上所有假玩家 1D200+等級的血量'],
        ['黑妖', '雙重破壞機率與破壞盔甲的爆傷比例都提高'],
        ['法師', '技能傷害整體提升，新增「究極光裂術」（需性向值 ≥500 才會使用）']
      ]) +
      wDesc('普通攻擊的傷害模型也改了：現在假玩家的普攻骰子跟「同等級一般怪物」的強度看齊，而且模板本身還會再乘上一個倍率（一般模板 ×2.0、第二模板 ×2.5，法師系不吃這個倍率），整體會比以前的假玩家更痛。') +
      wDesc('假玩家的等級不再封頂 100 級——高等玩家遇到的假玩家等級可能超過 100（玩家等級±10）。') +
      wDesc('擊殺假玩家後有機率收到嗆聲密語，可以選一句回嘴，回嘴後有機率讓對方記仇、之後在野外可能再遇到他來報仇（最多 3 次，跟花錢買的「復仇100,000」永久追殺是兩回事）。')
    );

    out += wCard('🌊 汙濁之水（新異常狀態）',
      wDesc('由白目玩家第二模板（妖精）施放，中招後<b>受到的治癒效果（藥水與治療技能）減半</b>，持續約 8 秒。玩家、傭兵、寵物都適用同一套規則。') +
      wDesc('可以用「相消術」或「魔法相消術」解除，跟凍結/中毒等其他異常一樣可以被這兩個技能一次清掉。')
    );

    out += wCard('💙 正義值高有這些好處：治癒魔法加成、究極光裂術門檻',
      wDesc('性向值 <b>≥1000</b> 起，你（或幫你施放的傭兵，看施法者自己的性向值）放的<b>初級／中級／高級治癒術、體力回復術、全部治癒術、生命的祝福、治癒魔法頭盔兩式</b>這 8 個治癒技能，實際回復量會額外提升，公式＝<b>1 ＋ 0.2 ×（性向值−1000）÷（32767−1000）</b>，滿性向值（32767）時 <b>+20%</b>，中立／邪惡則沒有這個加成（維持原本回復量）。') +
      wDesc('新技能<b>究極光裂術</b>設有「限正義性向」門檻：性向值<b>低於 1000 完全無法施放</b>（手動點、自動連放、傭兵AI代放都一樣會被擋下）。')
    );

    out += wCard('🔴 性向值太低（重度邪惡）有風險：死亡可能掉裝備',
      wDesc('性向值<b>低於 −10000</b> 時，每次死亡有 <b>1%</b> 機率隨機遺失一件裝備欄或背包裡的物品（強化與詞綴一併消失）。<b>目前沒有回收/復原的介面</b>，遺失了無法在遊戲內拿回來，重度邪惡玩家死亡要有心理準備。') +
      wDesc('吉爾塔斯魔杖／吉爾塔斯之劍的擊殺後額外加成（見「黑暗妖精聖地」分頁），也是依邪惡值高低縮放——越邪惡加成越大，中立以上（性向值 ≥0）完全沒有加成，是同一套性向值系統的另一個應用。')
    );

    out += wCard('💰 復仇名單：花錢追殺打死過你的假玩家',
      wDesc('被假玩家擊殺時，對方會自動被記進「復仇名單」（最多 <b>20</b> 筆，記錄他的性向值與打死你的次數）。在 PVP 分頁點「復仇 100,000」，付 <b>100,000</b> 金幣即可把該假玩家標記成永久追殺目標。') +
      wDesc('標記後這個目標<b>不會因為你死亡而解除</b>（跟上面「白目玩家」那種 2 小時記仇不同，這是花錢買的永久追殺），之後在野外還是有機率再遇到他、把他打死來出這口氣。')
    );

    out += wCard('⚔️ 決鬥競技場：跟其他玩家的真實角色對戰(v3.7.4起)',
      wDesc('這是跟上面「打假玩家NPC」完全不同的另一套PVP：透過<b>「對戰名片」</b>把你的角色（職業/等級/六維/裝備/技能/精通）打包成一段文字，對方拿這段文字就能挑戰你的<b>真實角色數據</b>，而不是隨機生成的NPC。') +
      wDesc('<b>怎麼進入</b>：到新村莊「' + wDexLink('古魯丁') + '」找NPC「鬥技場管理者巴魯特」互動，不用自己在地圖選單找（管理者會直接把你送進競技場）。') +
      wDesc('<b>對手怎麼選</b>：①點「複製名片」把自己的名片字串發給朋友，對方貼上你的名片字串就能挑戰；②如果對方也是你自己在玩的其他存檔位，可以直接從下拉選單挑選本機的其他存檔位，不用交換名片。') +
      wDesc('<b>戰鬥規則</b>：<b>1v1</b>，決鬥期間傭兵留在場邊觀戰（不會解散，決鬥結束自動歸隊）；對手法師會優先施放「目前冷卻已就緒、預期傷害最高」的法術（必放），比一般野外假玩家更會打；<b>雙方決鬥中都不能喝治癒藥水</b>（自動喝藥、手動使用、傭兵/寵物餵藥全部一起擋下）。') +
      wDesc('<b>沒有任何獎勵，也沒有任何懲罰</b>：不掉裝備、不給經驗金幣、落敗<b>完全無損失</b>（不扣經驗、不掉裝、不影響性向值），只累計「勝/敗/連勝/最高連勝」榮譽戰績與最近20場戰績歷史。單純是想跟朋友比實力、驗證配裝強度的玩法。') +
      wDesc('分出勝負後會跳結果視窗，可以選「留在競技場再打一場」（自動補滿HP/MP、解除死亡、傭兵寵物歸位）或「回古魯丁村莊」。')
    );

    out += '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:' + TAB_UPDATED.pvp + '(v3.5.75~76新增性向值/PVP系統；v3.6.35新增白目玩家第二模板/汙濁之水異常、性向懲罰值加倍；v3.7.4~17新增決鬥競技場)</div>';
    return out;
  }
  ...
  // 🌀 v3.4.67 起部分變身型態改用 apm(逐武器種類每分鐘攻擊次數)取代單一 atk 幀數值;無 f.atk 但有 f.apm 時,
  //   比照遊戲UI(js/02-stats-recompute.js)固定取「單手劍」代表值換算秒數,實際戰鬥仍依當前武器種類查表。
  var polyAtk  = function (f) {
    if (f.atk != null) return (Math.round(f.atk * 6000 / 1440) / 100).toFixed(2);
    if (f.apm) { var a = f.apm['單手劍'] || Object.values(f.apm)[0]; if (a) return (Math.round(6000 / a) / 100).toFixed(2) + '(依武器)'; }
    return '—';
  };
  ...
  function renderPoly() {
    ...
    if (typeof CONTROL_ONLY_POLY_FORMS !== 'undefined' && CONTROL_ONLY_POLY_FORMS.length) {
      h += '<div class="m-wiki-sub">💍 變形控制戒指專屬型態(夏納／真夏納)</div>';
      h += wDesc('這兩種型態<b>不會被變形卷軸隨機抽到</b>，只能靠<b>' + wDexLink('變形控制戒指') + '</b>指定變身；外觀維持你原本的職業性別動態(真夏納另有 16 職業性別專屬變身動態，招式更華麗)，只是攻擊／施法／被擊硬直的節奏被覆蓋成下表數值。');
      var coRows = CONTROL_ONLY_POLY_FORMS.map(function (f) {
        var castSec = f.castApm ? (60 / f.castApm).toFixed(2) : '—';
        var supSec = f.supportCastApm ? (60 / f.supportCastApm).toFixed(2) : '—';
        return ['Lv' + f.lv, '<span class="' + (f.c || '') + '">' + esc(f.n) + '</span>',
          f.trueShanna ? '逐武器查表(約0.63~0.8秒)' : '逐武器查表(約0.7~0.86秒)',
          castSec + ' 秒', supSec + ' 秒', polyWlk(f)];
      });
      h += wTbl(['需求等級', '型態', '攻擊間隔', '自動施法冷卻', '輔助施法冷卻', '怪物重生'], coRows);
      h += wDesc('真夏納(Lv85)是夏納(Lv52)的進階版，攻擊／輔助施法都更快，且換上專屬的職業變身動畫；兩者都只改變速度節奏，不附加傷害/命中/魔法等數值加成。');
      h += '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:2026-07-18(真夏納為原作v3.5.21新增；夏納為既有功能，此次補記錄)</div>';
    }
    // 📅 最後更新:2026-07-18 —— 補「變形控制戒指專屬型態(夏納／真夏納)」章節；「武器裝備觸發變身」:這兩把冥皇執行劍不進上面兩個表(不吃卷軸隨機池、不靠套裝件數),裝上武器就直接變身。
    h += '<div class="m-wiki-sub">⚔️ 武器裝備觸發變身</div>';
    h += wDesc('以下武器<b>裝備即刻自動變身</b>，不需額外操作，不進上面「隨機變形」或「套裝變身」池，<b>卸下武器變身立即消失</b>：');
    h += wTbl(['武器', '變身型態', '備註'], [
      [wE('受詛咒的真．冥皇執行劍'), '死亡騎士（一般變形池型態）', '若同時穿著套裝變身（如克特套裝），套裝變身優先，此武器變身會被跳過'],
      [wE('解除詛咒的真死亡騎士．冥皇執行劍') + '（遺物）', '真死亡騎士 冥皇丹特斯（Lv99專屬終極型態，不進一般變形池）', '額外攻擊15%機率觸發「' + wS('大地崩裂') + '」（全體8D12地屬性魔法傷害）；一般攻擊對地/風屬性敵人傷害×1.4']
    ]);
    return h;
  }
  ...
  function renderAlly() {
    ...
    var c1 = card('① 怎麼招募', { html: kvTbl([
      ...
      ['招得到誰', '你<b>其他存檔格</b>（共 8 格）有角色的格；目前所在格、空格、<b>已經是別人傭兵的角色</b>不能招'],
      ['費用', '<b>完全免費</b>（原本要角色等級×10000金幣，已取消）；也<b>取消「重新招募」按鈕</b>，改成你進安全區(城鎮)時自動幫全部傭兵刷新一次戰力'],
      ['同時上場', '<b>最多 3 名</b>（王族也是 3）'],
      ['遊戲模式', '一般／經典<b>兩組各自獨立</b>，只能招<b>同組合</b>的存檔'],
      ['獨佔', '同一個角色<b>同時只能當一個人的傭兵</b>，不能被兩個以上的角色重複招募；被別人招走的角色在選角畫面會掛紫色「擔任傭兵」徽章']
    ]) });

    // 2. 戰力怎麼算(3 條重點)
    var c2 = card('② 戰力＝招募快照，但會跟你一起升級', { lines: [
      '<b>招募當下的快照</b>：用他招募時的裝備／技能／精通／套裝／配點結算戰力（<b>吃他自己的精通、不吃你的</b>）。事後幫他換裝改精通不會自動跟上——要在公會點<b>「重新招募」</b>才更新（重招較便宜：Lv1 約 <b>1/10</b>、Lv50 約 <b>1/5</b>、Lv100 約 <b>1/2</b>）。',
    ...
    var aggroRows =
      ...
      '<tr>' + td('近戰 妖精／黑暗妖精／王族（輕裝）') + td('3', 'center') + '</tr>' +
      '<tr>' + td('近戰 騎士／戰士／龍騎士（重裝）') + td('4', 'center') + '</tr>';
    var reviveRows =
    ...
    var c5 = card('⑤ 會挨打、會倒地（不是永久死）', {
      html:
        desc('怪的<b>一般攻擊</b>與<b>單體攻擊魔法</b>會在「你＋在場傭兵」之間<b>依仇恨值挑一個</b>打；<b>全體技</b>（闇黑波動、毒霧…）則同時打你和所有傭兵。') +
        desc('🎯 <b>仇恨制</b>：每個目標的仇恨值＝「身分底分」＋「戰鬥中累積的仇恨」兩部分相加，兩者都會影響誰被鎖定：') +
        tbl(th('類型') + th('身分底分', 'center'), aggroRows) +
        desc('累積仇恨隨你/傭兵<b>造成的傷害、施放的治療</b>增加（近戰重裝職業、近戰武器種類權重更高；治療只算實際回復量的一半；寵物/召喚物/護衛一律算 1 倍），且每 10 秒會衰減一半——所以<b>火力愈猛、奶量愈大，愈容易被怪盯上</b>，不是打完全程都固定挑同一人。<b>持弓／遠程武器的身分底分較低、累積速度也較慢，天生比較不容易被鎖定。</b>身上裝著<b>隱身斗篷</b>類裝備則完全不會累積仇恨、永遠最不容易被盯上。') +
        desc('👉 帶<b>近戰重裝</b>傭兵在前排、讓他多打怪，就能幫脆皮施法傭兵（和你）分擔挨打——這套機制下「主動吸引怪」比單純「站前排」更有效。') +
        desc('HP 歸 0 →<b>倒地</b>（停手、不被鎖定、等復活），不是消失。也會像你一樣中<b>異常狀態</b>（中毒／灼燒持續扣血；暈眩／冰凍／石化／麻痺／沉睡不能動；沉默／魔封只能普攻；緩速攻速砍半）。') +
        desc('<b>你自己死了</b>傭兵仍留在身邊（回城／讀檔／離線回來都在）；<b>只有</b>公會點「⚠ 全員退出」才解散（經驗照記待領帳本）。') +
    ...
    var c6 = card('⑥ 傭兵會繼承本尊哪些能力', { lines: [
      '<b>幾乎照那角色本人的方式打</b>：會自動維持自己的增益魔法（覺醒／加速／狂暴術／神聖武器／各屬性 buff…、王族的灼熱武器／勇猛意志／閃亮之盾也在內），只付 MP 不扣 HP。',
    ...
    var c7 = card('⑦ 👑 王族加成 · 其他連動', { lines: [
      '👑 <b>王族魅力加成</b>：你是王族時，帶的<b>傭兵與項圈夥伴</b>的傷害／HP／MP 全部 <b>×(1＋魅力÷100)</b>（魅力 50→×1.5、80→<b>×1.8</b>）；非王族一律 ×1——這是王族「帶得更強」的專長。',
      '👑 <b>呼喚盟友</b>（指定給王族傭兵當攻擊技）：施放時<b>所有上場傭兵各多攻擊一次</b>。',
      '🔮 <b>幻術士魔力精通</b>：你每次耗 MP，所有<b>有 MP 的傭兵</b>回復「消耗量 10%」的 MP，讓施法傭兵不易斷魔。'
    ]});

    // 8. 傭兵召喚物(v3.4.50/51新增機制)
    var c8 = card('⑧ 傭兵的召喚物(召喚術/造屍術/屬性精靈)', { lines: [
      '傭兵學過召喚類技能（召喚術／造屍術／屬性精靈）時，會自動幫他召喚，並在隊伍面板顯示一張「傭兵召喚物」血量卡。',
      '<b>畫面上每個傭兵只會顯示「一張」召喚物卡</b>，不是每隻怪各一張——這是刻意簡化：實際打出的傷害仍然吃「召喚數量」（數量看該傭兵的<b>魅力</b>，公式同玩家自己召喚：數量＝(魅力+6)÷該生物的門檻值），數量越多輸出越高，但畫面上這幾隻怪的血量、死亡結算都<b>合併算成同一份</b>顯示，不會拆成好幾張卡。',
      '這份召喚物<b>沒有戰場圖像（sprite）</b>，只有這張血量卡；會被範圍傷害(AOE)波及、死亡會重新召喚。',
      '所以「明明魅力很高，召喚物卡怎麼只有 1 張」是<b>正常現象</b>，不是隻數算錯——隻數有反映在傷害輸出，只是介面呈現上合併成一張卡。'
    ]});
  ...
  function renderMode() {
    ...
    // 📅 最後更新:2026-07-21 —— 阿卡塔取消「僅經典模式」限制,新增裝備贖回(一般/經典皆可用)
    var c6 = card('💀 死亡經驗買回 + 裝備贖回（找聖使阿卡塔・位於' + wL('亞丁') + '城左上迴廊前）', '' +
      '<div class="m-wiki-desc"><b>【死亡經驗買回・經典模式限定】</b>經典模式每次死亡損失經驗時，系統會記一筆「等級、損失量」的紀錄(<b>最多存10筆</b>，滿了自動淘汰最舊的)；不需要當下正在死亡狀態，隨時可以去找阿卡塔查看並買回。</div>' +
      '<div class="m-wiki-desc" style="margin-top:4px;">・每筆買回費用 ＝ <b>死亡時等級 × 等級 × 1000</b> 金幣，買回經驗 ＝ 該筆實際損失經驗的 <b>50%</b>。買回後這筆紀錄立即銷毀，經驗直接加回並可正常升級。</div>' +
      '<div class="m-wiki-desc" style="margin-top:8px;"><b>【裝備贖回・一般/經典皆可用】</b>' + '<span style="color:#64748b;font-size:11px;">(2026-07-21新增)</span>邪惡(紅名)狀態下死亡遺失的裝備會被記錄(<b>最多5件</b>，滿了自動淘汰最舊的，含強化與詞綴)；找阿卡塔花 <b>1000 龍之鑽石</b>即可指定贖回其中一件，連同原本的強化值/詞綴一起拿回來。</div>'
    );

    return note + c1 + c3 + c4 + c5 + c6;
  }
  ...
  function renderDarkelfSanct() {
    ...
    return note + secs + '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:' + TAB_UPDATED.darkelf_sanct + '(補充吉爾塔斯之劍/魔杖的擊殺加成隨性向值縮放說明)</div>';
  }
  ...
  function renderPledge() {
    var out = '<div class="m-wiki-note">「血盟」是<b>同一帳號、同一模式(一般/經典)內共用</b>的成長系統：你名下該模式的所有角色都算同一個血盟成員，不是玩家對玩家的陣營對戰。<span style="color:#94a3b8;font-size:.85em;">（最後更新:2026-07-21，新增NPC血盟世界說明）</span></div>';

    out += wCard('🏛️ 創立與模式',
      wDesc('只有<b>王族(royal)</b>職業能創立血盟，花費 <b>30,000 金幣</b>、命名 1~20 字，創立者自動成為盟主。') +
      wDesc('<b>一般模式／經典模式的血盟各自獨立</b>：名稱、盟主、佔領城堡都分開算；但<b>血盟等級與經驗是全模式共用</b>，兩邊捐獻都會一起累加同一份等級進度。') +
      wDesc('非王族角色不用手動申請——角色屬於「已有血盟的那個模式」，開啟血盟分頁時就會自動算成該血盟成員。'));

    out += wCard('📈 血盟等級（全模式共用經驗）',
      wTbl(['等級', '升下一級所需經驗(貢獻)'], [
        ['1 → 2', '1,000'], ['2 → 3', '2,000'], ['3 → 4', '4,000'], ['4 → 5', '8,000'],
        ['5 → 6', '16,000'], ['6 → 7', '32,000'], ['7 → 8', '64,000'], ['8 → 9', '128,000'], ['9 → 10（滿）', '250,000']
      ]) +
      wDesc('經驗來源＝下面「捐獻」，捐多少貢獻同時就加多少血盟經驗；<b>最高 10 級</b>。'));

    out += wCard('💰 捐獻（累積貢獻、餵血盟升級）',
      wTbl(['捐獻物', '匯率'], [
        ['金幣', '10,000 金幣 → 1 點貢獻(須為 10,000 的倍數)'],
        ['龍之鑽石', '1 顆 → 100 點貢獻(走潘朵拉共用鑽石桶扣款)']
      ]) +
      wDesc('貢獻依<b>角色(存檔)各自累積</b>，不會因血盟升級被消耗，主要用途見下面「血盟 Buff」。'));

    out += wCard('💪 血盟 Buff（消耗自己的貢獻維持）',
      wDesc('血盟等級 1 級以上即可在分頁勾選開啟，開啟／維持每小時消耗 <b>5 點貢獻</b>(從你自己的貢獻扣)；貢獻不夠時自動關閉並跳系統訊息，關閉不退還當小時已收的費用。') +
      wTbl(['等級', 'HP', 'MP', '額外傷害', '額外命中', '魔防', '魔法傷害', 'HP恢復', 'MP恢復', 'AC'], [
        ['1', '+20', '+5', '+1', '+1', '+1', '+1', '+1', '+1', '-1'],
        ['2', '+30', '+5', '+1', '+1', '+2', '+1', '+2', '+2', '-1'],
        ['3', '+40', '+10', '+2', '+2', '+3', '+2', '+3', '+3', '-2'],
        ['4', '+50', '+15', '+2', '+2', '+4', '+2', '+4', '+4', '-2'],
        ['5', '+60', '+20', '+3', '+3', '+5', '+3', '+5', '+5', '-3'],
        ['6', '+70', '+25', '+3', '+3', '+6', '+3', '+6', '+6', '-3'],
        ['7', '+80', '+30', '+4', '+4', '+7', '+4', '+7', '+7', '-4'],
        ['8', '+100', '+35', '+4', '+4', '+8', '+4', '+8', '+8', '-4'],
        ['9', '+120', '+40', '+5', '+5', '+9', '+5', '+9', '+9', '-5'],
        ['10', '+150', '+50', '+5', '+5', '+10', '+5', '+10', '+10', '-5']
      ]));

    out += wCard('⚔️ 攻城戰（肯特城／風木城／海音城）',
      wTbl(['項目', '內容'], [
        ['條件', '該模式已創立/加入血盟・血盟創盟王族角色仍存在(盟主未被刪除)・<b>等級 40 以上</b>・血盟目前<b>未持有</b>該城'],
        ['冷卻', '<b>已取消</b>：不論勝負，結束後可立即再次宣戰'],
        ['流程(限時 30 分)', '攻破城門 → 進內城 → 時限內擊殺守護塔＝獲勝；逾時未擊殺＝失敗'],
        ['佔領', '獲勝即把城堡登記進血盟共用資料，同模式全部角色共用；若血盟原本持有別座城會自動放棄'],
        ['獲勝後落點', '<b>直接傳送到剛奪下的城堡</b>；戰敗或城堡資料寫入失敗才照舊送回原本的家鄉村莊'],
        ['特殊規則', '攻城區域(外門/內城)死亡一律不會掉落裝備']
      ]));

    out += wCard('🏆 佔領城堡的效益（同模式全部角色共用）',
      wTbl(['效益', '內容'], [
        ['商店', '全商店 8 折'],
        ['回城', '回村按鈕改為回血盟城堡'],
        ['城堡護衛/神官', '可到城堡雇用(見下)']
      ]) +
      wDesc('血盟持有城堡時，狀態列會顯示稱號徽章：<b>只有「王族」職業</b>會看到「城名 + 主」（例如「肯特城主」）並且旁邊多一個動態小王冠圖示；<b>非王族只會看到城堡名稱文字</b>（例如「肯特城」），沒有王冠圖示。城堡福利（全商店8折、開放城堡）王族/非王族都一樣，只是稱號顯示不同。'));

    out += wCard('🏰 城堡護衛 / 神官（佔領期間可雇一名）',
      wDesc('到持有的城堡找「傭兵隊長／神官隊長」雇一名；<b>同時只能一名</b>、不主動攻擊。設 HP 門檻(預設 50%)，你 HP 低於門檻才發動；費用一次付清、效果至失去城堡為止。') +
      wTbl(['城池', '護衛類型'], [
        ['肯特城', '幫你擋 10% 一般(物理)攻擊傷害'],
        ['風木城', '幫你擋 10% 魔法攻擊傷害'],
        ['海音城', '神官在你低血時每 16 秒補一次血(只計基礎值)']
      ]) +
      wDesc('護衛靠自己 HP 擋傷，被打到剩 1 就力竭，回到門檻(或回城堡補滿)才再啟動：') +
      wTbl(['護衛(肯特／風木)', 'HP', '費用', '每 16 秒回 HP'], [
        ['警衛', '300', '免費', '15'], ['守衛', '1000', '100 萬', '50'], ['鐵衛', '1500', '500 萬', '75']
      ]) +
      wDesc('神官靠自己 MP 治療，MP 耗盡就停，回到門檻(或回城堡補滿)才再治：') +
      wTbl(['神官(海音)', 'MP', '費用', '治癒等級', '每 16 秒回 MP'], [
        ['僧侶', '40', '免費', '初級', '2'], ['神官', '110', '100 萬', '中級', '5'], ['巫女', '200', '500 萬', '高級', '10']
      ]));

    out += wCard('🧭 依詩蒂／特羅斯（攻城戰入口NPC）',
      wDesc('血盟已創立時對他們互動，會直接開啟「宣布攻城戰」選單——目前只是攻城戰的觸發入口。'));

    out += wCard('🎯 魔物追蹤（想指定/單刷特定怪就靠這個）',
      wDesc('先攻下一座城，到城堡裡的追蹤 NPC(<b>奧貝勒(肯特城)／赫特(風木城)／帝倫(海音城)</b>)花 <b>100,000 金幣</b>指定某地區的某隻怪(<b>BOSS 不能追</b>)。接下來 <b>8 小時</b>你待在那張圖時，出怪有 <b>50%</b> 機率直接刷成指定那隻(隱藏狩獵區的怪無法指定)。') +
      wDesc('<b>額外例外：帶著傲慢之塔「支配符」不用進塔也能指定該段樓層</b>——背包裡帶著某段樓層(11~20樓、21~30樓…91~100樓)的<b>支配符</b>時，即使人不在塔裡，也可以在「魔物追蹤」直接指定該段樓層裡的怪物當追蹤目標。<b>只有支配符有這個效果，傳送符跟移動卷軸都不算</b>；資格只看身上「現在」有沒有帶著支配符，賣掉或存進倉庫該段樓層就會從可追蹤清單消失(已生效中的追蹤不會被中斷)，詳見「傲慢之塔」分頁。'));

    out += wCard('🔁 伊賽馬利（肯特城限定兌換/購買NPC）',
      wDesc('只有打下<b>肯特城</b>才出現的兌換NPC(風木、海音沒有)，可兌換卷軸與購買飾品施法卷軸；飾品購買設有<b>24小時</b>獨立冷卻。'));

    out += wCard('🏴 NPC血盟世界（20個電腦血盟，會互相打仗，你也能參戰）' + '<span style="color:#64748b;font-size:11px;">(2026-07-21)</span>',
      wDesc('遊戲裡固定存在 <b>20 個 NPC 血盟</b>，彼此之間會自己宣戰、求和、甚至爆發混戰，跟你的血盟系統是<b>平行的另一套機制</b>；只有<b>王族</b>能對 NPC 血盟宣戰/停止宣戰。血盟分頁的「宣戰列表」會列出全部 20 個(不用先遇過才看得到)，依外交狀態上色：' + wST('和平') + '(藍)／' + wST('宣戰') + '·' + wST('對方宣戰') + '(淺紅)／' + wST('互相宣戰') + '(深紅，最醒目)。') +
      wTbl(['數值', '說明'], [
        ['士氣(morale)', '上限 1000，用來判斷該血盟的活躍度，數字本身不直接顯示'],
        ['仇恨值(hatred)', '上限 100，<b>每小時自動衰退 1 點</b>；越高越容易在野外遇到該血盟發動團戰'],
        ['宣戰', '對某NPC血盟宣戰後<b>至少要維持24小時</b>才能停止；宣戰期間<b>同模式角色強制進入PVP狀態</b>。若對方也對你宣戰(互相宣戰)，野外遭遇機率更高'],
        ['求和', 'NPC血盟主動求和時可選擇接受(雙方解除敵對)或嘲諷(可能被拒絕、仇恨值直接衝到上限100，士氣+200)']
      ]) +
      wDesc('<b>野外遭遇</b>是兩層機率:先看有沒有觸發「野外PVP遭遇」——跟某NPC血盟互相宣戰時，這個基礎機率提高到<b>3%</b>；只有單方宣戰(不管是我方還是對方)時維持一般PVP基礎機率<b>1%</b>。觸發遭遇後，再看這次刷出的對手是不是真的來自該敵對血盟：<b>對方對你單方宣戰</b>時 <b>100%</b> 一定是；<b>互相宣戰</b>時 <b>80%</b> 機率是；<b>只有我方單方宣戰</b>時 <b>50%</b> 機率是(其餘情況刷一般的隨機PVP對手)。') +
      wDesc('<b>群體混戰</b>：某NPC血盟處於宣戰狀態且仇恨值>80時，狩獵中有 <b>1%</b> 機率該血盟直接發動團戰——狩獵區的怪全部清空、換成該血盟的「敵盟玩家」波次刷新，需要<b>擊退20~50名</b>(隨機)才算獲勝驅退，或直接離開該地圖也會結束(視為對方撤退)。') +
      wDesc('<b>攻城守城</b>：肯特城／風木城／海音城如果被某個NPC血盟佔領，攻城時會遇到該血盟指定的守城代表，擊敗守城代表期間你方重生速度只有平時的<b>一半</b>(比一般攻城更慢)。') +
      wDesc('<b>血盟解散</b>：NPC血盟本身可能會自動解散(各奔東西等隨機事件文案)，解散後該血盟名額會補上一個新血盟繼續維持20個。') +
      wDesc('<b>身分共用</b>：世界頻道的NPC(50%機率)、叫賣收購的流浪NPC(50%機率)都可能隨機加入這20個NPC血盟其中之一，跟野外遭遇的敵盟玩家是同一套命名池——同一個名字在不同地方看到，代表的是同一個「血盟身分」。'));

    out += '<div class="m-wiki-note" style="margin-top:10px;">📌 王族搜索狀這項道具、找依詩蒂/特羅斯加入血盟、消耗道具換取盟主祝福、以及攻城24小時冷卻，目前都不存在了；以上是目前實際生效的血盟規則。</div>';

    return out;
  }

  // 世界頻道問答系統(2026-07-21新增)：純社交模擬功能,答案盡量取自遊戲真實資料,不影響數值平衡。
  function renderWorldChat() {
    var out = '<div class="m-wiki-note">「世界頻道」是遊戲畫面右側/手機底部導覽「世界」分頁裡的聊天面板，可以打字向全世界發問，會有假的「線上玩家NPC」隨機回覆——純社交/趣味功能，跟你的角色數值、掉落、戰鬥完全無關。</div>';

    out += wCard('💬 怎麼用',
      wDesc('面板下方輸入框打字、按「發問」或 Enter 送出，系統會隨機挑<b>1~3位</b>線上玩家NPC回覆——可能認真回答，也可能只是路過的閒聊或互相嗆聲(約35%機率變成兩個NPC互嗆，跟你的問題無關)。') +
      wDesc('NPC名冊<b>只存在記憶體</b>，重新整理網頁就會換一批全新的人(名字、人格都重新抽)，不會累積成好友名單之類的東西。'));

    out += wCard('🎭 NPC 是怎麼組成的',
      wDesc('每位NPC隨機抽一種<b>人格</b>(熱心助人／資深玩家／毒舌／新手／商人)，回話的語氣、開場白會依人格不同。') +
      wDesc('名字跟野外遇到的敵對玩家NPC、黑市叫賣NPC<b>共用同一套命名池</b>，所以同一個名字在世界頻道、黑市、野外看到，代表的是同一個「身分」，且都可能隨機加入前面「血盟」分頁提到的20個NPC血盟之一(機率50%)。') +
      wDesc('答案<b>盡量取自遊戲內真實資料</b>(地圖等級範圍、裝備職業限制、精通表等)動態拼湊出來，不是寫死的攻略文字——但畢竟是模擬對話，別把它當成正式攻略引用，資料異動時難免會有跟不上的空窗期。'));

    out += wCard('👆 點NPC名字：嘲諷 / 感謝',
      wDesc('點任一則訊息裡的NPC名字會跳出小選單：') +
      wTbl(['選項', '效果'], [
        ['嘲諷', '依對方性向值決定是否記仇(邪惡100%／中立50%／正義20%，同黑市叫賣NPC規則)，記仇後可能在野外被追殺，也可能反過來把你封鎖'],
        ['感謝', '單純的好感回覆，若對方原本記仇你，感謝可以讓對方消氣(移除追殺)']
      ]) +
      wDesc('<b>只有「嘲諷記仇」這件事會寫進存檔</b>，其餘對話內容、NPC名冊都是暫時性的，重整頁面就清空。'));
  ...
  var MAGIC_FACT = {
    // ===== 法師魔法(reqM) =====
    sk_heal1: ['回復量＝(20~40)×(1＋3×魔法傷害÷16)，吃智力、不吃階級；只治療自己；正義值(≥1000)起施法者性向值越高恢復量越高，滿正義(32767)額外 +20%，中立/邪惡無提升'],
    sk_lightarrow: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.10', 'MP 消耗隨智力降低(智力 45 以上最多省 30%)，不隨階級變'],
    sk_icearrow: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.10；打火屬怪 ×1.4、被風屬怪剋 ×0.6'],
    sk_windblade: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.10；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    sk_sunlight: ['讓被動怪主動接近你的延遲從約 5 秒縮到約 1 秒(更快遇敵)', '軍王之室、底比斯祭壇內無效'],
    sk_holy_wpn: ['攻擊不死系怪每擊再加 1~20 傷害(等於臨時聖武器)；但武器本身已剋不死(銀斧/精靈短劍/銀箭等)就不疊加，對狼人無效'],
    sk_firearrow: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.20；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_hell_fang: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.20；打風屬怪 ×1.4、被火屬怪剋 ×0.6'],
    sk_cold_shiver: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.20', '吸取與傷害等量的生命(最多回到滿血)'],
    ...
    sk_aurora: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.30；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    sk_chill: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.30；打火屬怪 ×1.4、被風屬怪剋 ×0.6'],
    sk_heal_mid: ['回復量＝(51~100)×(1＋3×魔法傷害÷16)，吃智力、不吃階級；只治療自己；正義值(≥1000)起施法者性向值越高恢復量越高，滿正義(32767)額外 +20%，中立/邪惡無提升'],
    sk_dark_blind: ['本身不造成傷害；命中 −4(更容易揮空)、持續 10 秒，依異常魔法命中判定(等級＋魔法命中 對 怪等＋魔防)'],
    sk_undead_bane: ['成功率最高 60%(依等級＋魔法命中 對 怪等＋魔防浮動)，對王級(頭目)無效'],
    sk_fireball: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.40；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_rock_prison: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.40；打風屬怪 ×1.4、被火屬怪剋 ×0.6'],
    sk_vampire: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.40', '吸取與傷害等量的生命(最多回到滿血)'],
    ...
    sk_thunder: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.50；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    sk_ice_spike: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.50；打火屬怪 ×1.4、被風屬怪剋 ×0.6'],
    ...
    sk_heal2: ['回復量＝(101~200)×(1＋3×魔法傷害÷16)，吃智力、不吃階級；只治療自己；正義值(≥1000)起施法者性向值越高恢復量越高，滿正義(32767)額外 +20%，中立/邪惡無提升'],
    ...
    sk_earthquake: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.60；打風屬怪 ×1.4、被火屬怪剋 ×0.6'],
    sk_blaze: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.60；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_weaken: ['本身不造成傷害；使目標命中 −2、攻擊傷害 −4、持續 30 秒，依異常魔法命中判定(等級＋魔法命中 對 怪等＋魔防)'],
    sk_haste_spell: ['戴風之頭盔時免 MP 施放'],
    sk_zombie: ['傷害命中吃魅力；每輪段數＝魅力÷6(魅力 60 封頂、最多 10 段)，召喚精通時判定改魅力×1.2', '每段＝(1~12)＋(魅力÷5×(1＋等級÷20))再扣目標防禦', '同時只能開一個召喚增益(造屍/召喚/精靈)，迷魅可並存'],
    sk_cancel: ['解除冰凍、石化、中毒、麻痺、灼燒、燙傷六種；一次只解一人、優先自己', '被沉默或魔法封印時放不出來'],
    sk_ice_lance: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.70；打火屬怪 ×1.4、被風屬怪剋 ×0.6', '附帶冰凍 6 秒(依異常魔法命中判定，對王級無效)'],
    sk_tornado: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.70；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    sk_disease: ['本身不造成傷害；使目標防禦(AC) 變差 8(更好打中)、命中 −4、持續 30 秒，依異常魔法命中判定(等級＋魔法命中 對 怪等＋魔防)'],
    sk_greater_haste: ['戴風之頭盔時免 MP 施放'],
    sk_holy_dash: ['移動速度 +33%(速度×1.33)；與「風之疾走」互斥，同時學會/持有時後放的會取代先放的，不重複疊加'],
    sk_summon: ['召喚物隨等級自動換階(七種：32/40/52/60/64/72 級，Lv72 換到黑豹，60 級以上附額外觸發技)', '傷害命中吃魅力；每輪段數＝魅力÷6(魅力 60 封頂、最多 10 段)，召喚精通時判定改魅力×1.2', '同時只能開一個召喚增益(造屍/召喚/精靈)，迷魅可並存'],
    sk_regen: ['施放即<b>立即治癒全隊一次</b>(你＋所有傭兵)，不再是每3秒跳一次的持續回復；之後進入 3 秒冷卻才能再放；正義值(≥1000)起施法者性向值越高恢復量越高，滿正義(32767)額外 +20%，中立/邪惡無提升'],
    sk_quake: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.80；打風屬怪 ×1.4、被火屬怪剋 ×0.6'],
    sk_blizzard: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.80；打火屬怪 ×1.4、被風屬怪剋 ×0.6'],
    sk_fire_prison: ['增益欄勾選維持的範圍持續傷害：每 2 秒對全體造成一次(基礎骰值 ×(1＋3×魔法傷害÷16)×階級係數 ×3.67)，維持 10 秒約 5 次，效果結束才能再放'],
    sk_seal: ['本身不造成傷害；真空 16 秒，依異常魔法命中判定(等級＋魔法命中 對 怪等＋魔防)'],
    sk_invisible: ['隱身期間，滿血的一般怪不會主動攻擊你'],
    sk_full_heal: ['回復量＝(153~300)×(1＋3×魔法傷害÷16)，吃智力、不吃階級；只治療自己；正義值(≥1000)起施法者性向值越高恢復量越高，滿正義(32767)額外 +20%，中立/邪惡無提升'],
    ...
    sk_thunder_storm: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.90；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    sk_fire_storm: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×1.90；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_meteor: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×2.00；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_disintegrate: ['傷害吃「魔力點數SP」(智力提供＋道具/套裝加成，智力部分封頂33)並依目標屬性抗性打折；階級加成 ×2.00', '<b>限正義性向施放</b>：性向值需 ≥1000，不足時手動/自動施放與傭兵代放都會被擋下(見「性向與PVP」分頁)'],
    sk_blizzard_storm: ['增益欄維持的範圍持續傷害：每 4 秒對全體造成一次(基礎骰值 ×(1＋3×魔法傷害÷16)×階級係數 ×4.33)並判定冰凍(魔法命中 −3)，維持 32 秒約 8 次，效果結束才能再放'],
    sk_abs_barrier: ['隔絕結束後還要再等 12 秒才能再施放'],
    sk_heal_energy_storm: ['本身不直接造成傷害/治療；施放後<b>320秒內</b>，你(與吃到同一份增益共享的傭兵)的HP自然恢復間隔從原本16秒縮短為<b>3秒</b>，等於大幅加速自然回血。持續中不能重複施放(noRefresh)，消耗MP20'],
    ...
    sk_elf_winddash: ['移動速度 +33%(速度×1.33)，取代精靈餅乾的移速加成(餅乾仍保留攻速)；與「神聖疾走」互斥、優先生效不重複疊加'],
    sk_elf_groundtrap: ['本身不造成傷害，使全體緩速 30 秒(攻擊間隔拉長 1 秒)；依異常魔法命中判定(等級＋魔法命中 對 怪等級＋魔防)'],
    sk_elf_watervital: ['「下一次瞬間治癒」(不含持續回復)治療量 ×2、全隊共用一次，觸發後 7 秒冷卻；效果結束才能再施放'],
    sk_elf_magicerase: ['本身不造成傷害，使目標魔防減半 16 秒；命中即完整 16 秒(非每發魔法各觸發一次)', '依異常魔法命中判定；頭目/高魔防怪常連續抵抗，畫面上魔防減半一閃即逝多半是被抵抗、非只持續一瞬'],
    sk_elf_summon: ['每 1 秒攻擊一次；傷害與命中吃「魅力」：每擊＝骰值 1~40 ＋ 魅力×等級÷20，再扣魔防與傷害減免', '隻數：無精靈精通固定 1 隻；有精靈精通＝1＋魅力÷10(最多 7 隻，魅力以 60 封頂)', '造屍術/召喚術/屬性精靈同時只能開一個，迷魅術可另外並存'],
    sk_elf_earthshield: ['期間完全免疫怪物「一般攻擊/連擊」傷害，但對敵方魔法無效'],
    sk_elf_lifespring: ['<b>直接把目標HP補滿(完全復原)</b>，不再吃智力/魔法傷害成長；單體，之後進入 20 秒冷卻才能再放'],
    sk_elf_earthbless: ['防禦(AC) 加成全隊生效(你＋所有傭兵)'],
    sk_elf_summon2: ['每 1 秒攻擊一次；每擊＝骰值 2~80 ＋ 魅力×等級÷10、命中偏移 +20，吃魅力', '隻數公式同屬性精靈(1＋魅力÷10、上限 7、魅力封頂 60)；同時只能開一個召喚增益'],
    sk_elf_lifebless: ['施放即<b>立即治癒全隊一次</b>(你＋所有傭兵)，不再是每3秒跳一次的持續回復；之後進入 6 秒冷卻才能再放；正義值(≥1000)起施法者性向值越高恢復量越高，滿正義(32767)額外 +20%，中立/邪惡無提升'],
    ...
    sk_elf_steelguard: ['僅施法者自身防禦(AC) −10；不再是全隊減傷(舊版是全隊受到傷害−5%，已改版)'],
    sk_royal_burnweapon: ['團隊光環：施放一次全隊(你＋傭兵＋寵物＋召喚物)都吃到額外傷害/命中各 +5，不必逐一補'],
    sk_royal_shield: ['團隊光環：施放一次全隊(你＋傭兵＋寵物＋召喚物)都吃到防禦(AC) −8，不必逐一補'],
    ...
    sk_elf_muddywater: ['<b>只能對頭目施放</b>(非頭目目標會退回一般攻擊、不扣MP)；本身不造成傷害，必定命中(不需命中判定)', '使頭目的<b>HP自然恢復量減半</b>，持續 32 秒；消耗MP20'],
    ...
    sk_illu_avatar: ['受到所有傷害 -3%，且此減免與額外傷害都全隊(你＋所有傭兵)生效'],
    ...
    sk_helm_heal1: ['實際治療量再乘 (1＋3×魔法傷害÷16)，隨智力(魔法傷害)成長；正義值(≥1000)起施法者性向值越高恢復量越高，滿正義(32767)額外 +20%，中立/邪惡無提升'],
    sk_helm_heal2: ['實際治療量再乘 (1＋3×魔法傷害÷16)，隨智力(魔法傷害)成長；正義值(≥1000)起施法者性向值越高恢復量越高，滿正義(32767)額外 +20%，中立/邪惡無提升'],
  ...
  function gameSkillIntroHTML(id, sk) {
    ...
    if (sk.healBase || sk.healDice) eff.push('治療 ' + (sk.healBase || 0) + (sk.healDice ? ('＋' + gsDiceRange(sk.healDice[0], sk.healDice[1])) : ''));
  ...
  function magicSpellHTML(id, sk, lvLabel, learnedSet) {
    ...
    return '<div class="m-wiki-spell' + learnCls + '">' + icon +
      '<div class="m-wiki-spell-main">' +
        ...
        (MAGIC_FACT[id] ? '<div class="m-wiki-desc m-wiki-spell-fact">' +   // 📐 逐條追程式碼查證的實際數據(金框,比照職業專精)
          '<b style="color:#fbbf24;">📐 實際數據</b>' +
  ...
  function renderMagic(magicCls) {
    ...
    html += '<div class="m-wiki-note">⚔️ <b>攻擊魔法的實際傷害不只看「威力」骰子。</b>每段傷害 ≈ <b>骰子 ×（1＋階級÷3）×（1＋3×魔法傷害÷16）</b>，最後扣目標魔防(MR)。<b>階級越高、倍率越大</b>——所以高階魔法即使骰子看起來差不多甚至略低，實際往往更強。<br>例：流星雨(10 階，骰 6~90) 與冰雪暴(8 階，骰 8~80) 平均骰值相近，但把階級係數乘進去後<b>流星雨實際約強 29%</b>。<br>⚠️ <b>魔法傷害只由「智力」換算——所有攻擊魔法都吃智、不吃力</b>（含龍騎的岩漿噴吐／岩漿之箭）。每招下方金框 <b style="color:#fbbf24;">📐 實際數據</b> 是逐條追程式碼查證的真實公式（含吃哪個屬性、隱藏數字）。</div>';
    if (magicCls !== 'all') {
      var rows = [];
