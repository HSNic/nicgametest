...
(function () {
  ...
  function renderPets() {
    ...
    var note = '<div class="m-wiki-note">「帶寵物」是<b>任何職業</b>都能玩的夥伴系統(v3.2.17全面改版，取代舊版吃肉/項圈/哨子玩法)：用專屬誘捕道具捕捉野外動物送進' + wN('包武') + '的' + wI('寵物保管') + '，寵物是有等級/經驗/HP/MP的<b>獨立實體</b>，最多同時<b>出戰4隻</b>幫你打怪。</div>' +
      '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:2026-07-17</div>';
    var lureRows = [
  ...
  function renderPvp() {
    ...
    out += wCard('⚖️ 性向值：打死正義/邪惡假玩家的影響',
      wTbl(['行為', '性向值變化'], [
        ['擊殺一般小怪（非血盟、非攻城）', '<span style="color:#86efac">+1</span>'],
        ['擊殺「正義」假玩家（性向值 ≥ 1000）', '<span style="color:#f87171">−3000</span>'],
        ['擊殺「中立偏邪惡」假玩家（&gt;−1000 但 &lt;1000）', '<span style="color:#f87171">−500</span>'],
        ['擊殺「邪惡」假玩家（性向值 ≤ −1000）', '不扣分']
      ]) +
      wDesc('性向值範圍 <b>−32767 ~ +32767</b>：<b>≥1000</b> 算「正義」、<b>≤−1000</b> 算「邪惡」，中間算「中立」。想維持正義稱號，盡量別去打正義向的假玩家。')
    );
    ...
    out += '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:' + TAB_UPDATED.pvp + '(v3.5.75~76新增性向值/PVP系統：治癒加成、究極光裂術門檻、復仇名單、邪惡值死亡掉裝風險)</div>';
    return out;
  }
  ...
  function renderPledge() {
    var out = '<div class="m-wiki-note">「血盟」是<b>同一帳號、同一模式(一般/經典)內共用</b>的成長系統：你名下該模式的所有角色都算同一個血盟成員，不是玩家對玩家的陣營對戰。<span style="color:#94a3b8;font-size:.85em;">（最後更新:2026-07-19）</span></div>';
