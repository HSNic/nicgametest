...
(function () {
  ...
  function renderPets() {
    ...
    var secs = [
      ...
      { t: '⑥ 寵物保管(找亞丁的包武)', body:
        wDesc(wN('包武') + '(位於' + wL('亞丁') + '城右下拱廊前)幫你保管寵物，最多<b>20隻</b>(含出戰中的)，<b>同模式(一般/經典)全部角色共通</b>——和單一角色專屬的舊系統不同，帳號底下任何角色都能看到同一批寵物。') +
  ...
  function renderPandora() {
    ...
    out += '<div class="m-wiki-desc" style="color:#64748b;font-size:11px;">最後更新:' + TAB_UPDATED.pandora + '(v3.5.36新增遺物布告欄與玩家收購NPC/收購單機制;v3.5.59新增白目玩家記仇/敵對怪機制;補嘲諷選單記仇機率依對方性向值/封鎖機制說明)</div>';
    return out;
  }
  ...
  function renderPledge() {
    var out = '<div class="m-wiki-note">「血盟」是<b>同一帳號、同一模式(一般/經典)內共用</b>的成長系統：你名下該模式的所有角色都算同一個血盟成員，不是玩家對玩家的陣營對戰。<span style="color:#94a3b8;font-size:.85em;">（最後更新:2026-07-20，補城主稱號UI改版說明）</span></div>';
