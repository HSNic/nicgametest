...
(function () {
  ...
  var MASTERY_FACT = {
    ...
    k_royal_pet: ['魅力係數 ×1.2 與王族被動（夥伴傷害 ×(1＋魅力/100)）相乘', '夥伴觸發魔法（進化夥伴 10% proc）每次額外＋完整魅力值固定傷害（不受 60 封頂）'],
  ...
  function renderPets() {
    ...
    var secs = [
      ...
      { t: '③ 夥伴怎麼打（每次攻擊消耗 1 塊肉）', lines: [
        ...
        '👑 <b>王族專屬加成</b>：你是王族時，項圈夥伴的<b>傷害、HP、MP 全部 ×(1＋魅力÷100)</b>（魅力 80 上限＝×1.8）；非王族一律 ×1。（傭兵也吃同一加成，見「傭兵」分頁。）'
      ]},
      { t: '④ 進化：把基礎犬變更強', lines: [
  ...
  var MAGIC_FACT = {
    ...
    sk_lightarrow: ['吃智力(魔法傷害)；階級係數 ×1.33', 'MP 消耗隨智力降低(智力 45 以上最多省 30%)，不隨階級變'],
    sk_icearrow: ['吃智力(魔法傷害)；階級係數 ×1.33；打火屬怪 ×1.4、被風屬怪剋 ×0.6'],
    sk_windblade: ['吃智力(魔法傷害)；階級係數 ×1.33；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    ...
    sk_firearrow: ['吃智力(魔法傷害)；階級係數 ×1.67；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_hell_fang: ['吃智力(魔法傷害)；階級係數 ×1.67；打風屬怪 ×1.4、被火屬怪剋 ×0.6'],
    sk_cold_shiver: ['吃智力(魔法傷害)；階級係數 ×1.67', '吸取與傷害等量的生命(最多回到滿血)'],
    ...
    sk_aurora: ['吃智力(魔法傷害)；階級係數 ×2；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    sk_chill: ['吃智力(魔法傷害)；階級係數 ×2；打火屬怪 ×1.4、被風屬怪剋 ×0.6'],
    ...
    sk_fireball: ['吃智力(魔法傷害)；階級係數 ×2.33；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_rock_prison: ['吃智力(魔法傷害)；階級係數 ×2.33；打風屬怪 ×1.4、被火屬怪剋 ×0.6'],
    sk_vampire: ['吃智力(魔法傷害)；階級係數 ×2.33', '吸取與傷害等量的生命(最多回到滿血)'],
    ...
    sk_thunder: ['吃智力(魔法傷害)；階級係數 ×2.67；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    sk_ice_spike: ['吃智力(魔法傷害)；階級係數 ×2.67；打火屬怪 ×1.4、被風屬怪剋 ×0.6'],
    ...
    sk_earthquake: ['吃智力(魔法傷害)；階級係數 ×3；打風屬怪 ×1.4、被火屬怪剋 ×0.6'],
    sk_blaze: ['吃智力(魔法傷害)；階級係數 ×3；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    ...
    sk_ice_lance: ['吃智力(魔法傷害)；階級係數 ×3.33；打火屬怪 ×1.4、被風屬怪剋 ×0.6', '附帶冰凍 6 秒(依異常魔法命中判定，對王級無效)'],
    sk_tornado: ['吃智力(魔法傷害)；階級係數 ×3.33；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    ...
    sk_regen: ['全隊(你＋所有傭兵)每 3 秒回 1 次、共 5 次(15 秒)，每次＝(31~60)×(1＋3×魔法傷害÷16)，吃智力'],
    sk_quake: ['吃智力(魔法傷害)；階級係數 ×3.67；打風屬怪 ×1.4、被火屬怪剋 ×0.6'],
    sk_blizzard: ['吃智力(魔法傷害)；階級係數 ×3.67；打火屬怪 ×1.4、被風屬怪剋 ×0.6'],
    ...
    sk_thunder_storm: ['吃智力(魔法傷害)；階級係數 ×4；打水屬怪 ×1.4、被地屬怪剋 ×0.6'],
    sk_fire_storm: ['吃智力(魔法傷害)；階級係數 ×4；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_meteor: ['吃智力(魔法傷害)；階級係數 ×4.33；打地屬怪 ×1.4、被水屬怪剋 ×0.6'],
    sk_disintegrate: ['吃智力(魔法傷害)；階級係數 ×4.33'],
    ...
    sk_elf_lifespring: ['實際治療＝顯示值 ×(1＋3×魔法傷害÷16)，吃智力成長'],
    ...
    sk_elf_lifebless: ['全隊持續回復：每 3 秒 1 次、共 6 次(約 18 秒)；每次治療＝顯示值 ×(1＋3×魔法傷害÷16)，吃智力'],
