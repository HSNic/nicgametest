...
const need = ['[AFK]', '[AFK-offline-profiler]', '[AFK-slotinfo]', '[AFK-dex]', '[AFK-wiki]', '[AFK-fixes]', '[AFK-syncinfo]', '[AFK-statpts]', '[AFK-pwa]', '[AFK-storage]', '[AFK-history]', '[AFK-mobname]', '[AFK-training]', '[AFK-skin]', '[AFK-classic-list]', '[AFK-autosell-fix]', '[AFK-item-subfilter]', '[AFK-uilayout]', '[AFK-autosell-ui]', '[AFK-player-ring]', '[AFK-batch-sell]', '[AFK-doll-pet]', '[AFK-itemsearch]', '[AFK-cloud-sync-v2]', '[AFK-panacea]', '[AFK-whdeposit-bycat]', '[AFK-char-switch]', '[AFK-asset-manager]', '[AFK-batch-settle]', '[AFK-junk2rule]', '[AFK-lachesis-refresh]', '[AFK-crit-heavy-fx-v2]', '[AFK-ally-buffs]', '[AFK-quickpanel]', '[AFK-whatsnew]', '[AFK-status-always-text]', '[AFK-diagnostics]'];
