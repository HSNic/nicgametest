...
(function () {
  ...
  var CHANGELOG = [
    {
      date: '2026-07-24', title: '合併原作v3.8.1:仇恨制、攻城戰V2、安塔瑞斯副本等大量新內容',
      wiki: { tab: 'antharas' },
      items: [
        { text: '怪物選誰當攻擊目標改成「仇恨制」:誰打得越兇、補得越多越容易被盯上,不再是固定不變。' },
        { text: '新增「安塔瑞斯副本」:找威頓村NPC多魯嘉貝爾進入,每日全帳號限通關1次,掉落專屬裝備與幼龍蛋。' },
        { text: '傭兵制度大改:招募改成完全免費、同一角色不能被兩人同時招募為傭兵。' },
        { text: '攻城戰、城堡守衛系統整套重寫,決鬥競技場多項細節調整,新增遺物34件。' }
      ]
    },
    {
      date: '2026-07-24', title: '修離線掛機紀錄視窗誤退出遊戲 + 補掛機補跑經驗值顯示',
      items: [
        { text: '修正「離線掛機紀錄」視窗切換時,少數情況下可能誤退出整個遊戲的問題。' },
        { text: '「掛機補跑完成」的提示訊息補上經驗值(原本只顯示時間與金幣)。' },
        { text: '修正手機版選角畫面「擔任傭兵」徽章被裝飾圖蓋住看不見的問題。' }
      ]
    },
    {
      date: '2026-07-22', title: '修批次結算物品/獎勵拿不到',
      items: [
        { text: '修正「批次結算所有存檔位」時,快速切換角色會誤把上一個角色的位置傳給下一個,導致部分角色獎勵算錯或拿不到的問題。' }
      ]
    },
    {
