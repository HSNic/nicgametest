 ...
 * ========================================================================== */
const CODE_VERSION = 'code-9ecd4bae6c3f';   // ← scripts/stamp-sw-version.mjs 自動覆寫,勿手改
const BUILD_ID     = '0718-0146'; // ← stamp 在 CODE_VERSION 變動時一起更新成台灣時間 MMDD-HHMM(僅供畫面辨識版本)
